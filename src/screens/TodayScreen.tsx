...
const styles = StyleSheet.create({
  ...
  highlightRow: { marginBottom: 20, padding: spacing.md, backgroundColor: '#FFFDF9', borderWidth: 1.5, borderLeftWidth: 4, borderColor: '#B7AA96', borderLeftColor: colors.vermilion, borderRadius: 18, shadowColor: '#333333', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 14, elevation: 3 },
  ...
  highlightFooter: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12, marginTop: 12, paddingTop: 12, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#E2D9CC' },
